<%-- 
    ...
    Sistema             : GC-Business
    Módulo              : Productos
    Nombre              : GC-Business-GestionTarifa.jsp
    Versión             : 1.0
    Fecha Creación      : 21-08-2018
    Autor Creación      : Pablo Jimenez Aguado
    Uso                 : Crear, Modificar, Consultar e Inactivar una tarifa
--%>
...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>GC BUSINESS - Gestión de Tarifas</title>
    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Crear, modificar, eliminar tarifas
                                </small>
                            </h1>
                        </div><!-- /.page-header -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div>
                                    <table id="tablaTarifas" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>Nro</th>
                                                <th>Descripción</th>    
            ...
            <!-- Modales -->
            <div class="modal" id="modalAgregarTarifa" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="blue bigger">Registrar Nueva Tarifa</h4>
                        </div>
        ...
        <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        $('body').on('shown.bs.modal', '#modalAgregarTarifa', function () {
                            $('input:visible:enabled:first', this).focus();
                        });

                        var tablaTarifas = $('#tablaTarifas').DataTable({
                            bAutoWidth: false,
                            "processing": true,
                        ...
                        new $.fn.dataTable.Buttons(tablaTarifas, {
                            buttons: [
                                {
                                    ...
                                    "action": function () {
                                        ...
                                        $('#modalAgregarTarifa .blue').text('Registrar Nueva Tarifa');
                                        $('#modalAgregarTarifa').modal('show');
                                        $('.divError').empty();
                                    }
                                },
                                {
                        ...
                        tablaTarifas.buttons().container().appendTo($('.tableTools-container'));
                        ...
                        $('#btnGuardar').click(function (event) {
                            ...
                            $.ajax({
                                method: "POST",
                                url: "../Tarifa",
                                data: {"opcion": opcion, "idtarifa": idtarifa, "descripcion": descripcion, "abreviatura": abreviatura, "estado": estado}
                            }).done(function (data) {
                        ...
                        $(document).on('click', '.actualizar', function () {
                            ...
                            $.ajax({
                                url: "../Tarifa",
                                method: "POST",
                                data: {"opcion": "buscar", "idtarifa": idtarifa},
                                success: function (data) {
                                    var obj = jQuery.parseJSON(data);
                                    $('#opcion').val('actualizar');
                                    $('#idtarifa').val(obj.idtarifa);
                                    $('#descripcion').val(obj.descripcion);
                                    $('#abreviatura').val(obj.abreviatura);
                                    $('#estado').val(obj.estado);
                                    $('#divestado').hide();
                                    $('#modalAgregarTarifa .blue').text('Modificar Tarifa');
                                    $('#modalAgregarTarifa').modal('show');
                                },
                        ...
                        $(document).on('click', '.eliminar', function () {
                            ...
                            $.ajax({
                                url: "../Tarifa",
                                method: "POST",
                                data: {"opcion": "eliminar", "idtarifa": idtarifa},
                                success: function (data) {
                                    var obj = jQuery.parseJSON(data);
                                    if (obj.mensaje.indexOf('ERROR') !== -1) {
                                        $('.divError').html(obj.html);
                        ...
                        $(document).on('click', '.activar', function () {
                            ...
                            $.ajax({
                                url: "../Tarifa",
                                method: "POST",
                                data: {"opcion": "activar", "idtarifa": idtarifa},
                                success: function (data) {
                                    var obj = jQuery.parseJSON(data);
                                    if (obj.mensaje.indexOf('ERROR') !== -1) {
                                        $('.divError').html(obj.html);
