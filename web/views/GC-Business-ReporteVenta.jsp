                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div style="margin-left: 200px;">
                            ...
                            &nbsp;
                            <label for="sucursal" class="control-label hide">Sucursal: </label>
                            <select id="sucursal" name="sucursal" tabindex="4" style="width: 130px;" class="hide">
                            ...
                            &nbsp;
                            <label for="almacen" class="control-label hide">Almacén: </label>
                            <select id="almacen" name="almacen" tabindex="4" style="width: 130px;" class="hide">
                            </select>
                        </div>
                        <hr>
    ...
    <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        $('.generar').click(function (event) {
                            ...
                            window.open('../Reporte?opcion=VE&fileType='+fileType +'&fdesde='+fdesde+'&fhasta='+fhasta+'&idvendedor='+idvendedor+'&idsucursal='+idsucursal+'&idalmacen='+idalmacen, '_blank');
                        });
