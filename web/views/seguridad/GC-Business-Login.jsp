                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    <span class="green">GC BUSINESS</span>
                                </h1>
                                <h4 class="blue" id="id-company-text">&copy; Gilead Consulting</h4>
                            </div>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <select id="sucursal" name="sucursal" tabindex="3" class="form-control">
                                                            </select>
                                                        </div>
                                                    </div>                                                
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <select id="almacen" name="almacen" tabindex="4" class="form-control">
                                                            </select>
                                                        </div>
                                                    </div>  
                    ...
                    $.getJSON("SucursalAlmacen", {user: user, pass: pass, accion:"sucursal"}, function (data, textStatus, jqXHR) {
                        ...
                        $.each(data, function (index, item) {//recorremos la lista
                            $("<option/>") //creamos un objeto option...
                                    .attr("value", item.idSucursal) //.. con el valor
