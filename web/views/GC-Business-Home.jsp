...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>GC BUSINESS - Inicio</title>
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="">
                        ...
                        <ul class="submenu">
                            ...
                            %>
                            <li class="">
                                <a href="views/GC-Business-GestionEmpresa.jsp">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Empresa
                                </a>
                            ...
                            %>
                            <li class="">
                                <a href="views/GC-Business-GestionSucursal.jsp">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Sucursales
                                </a>
                            ...
                            %>
                            <li class="">
                                <a href="views/GC-Business-GestionAlmacen.jsp">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Almacenes
                                </a>
                            ...
                            %>
                            <li class="">
                                <a href="views/GC-Business-GestionVendedor.jsp">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Vendedores
                                </a>
                            ...
                            %>
                            <li class="">
                                <a href="views/GC-Business-GestionUsuario.jsp">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Usuarios
                                </a>
                    ...
                    <li class="">
                        ...
                        <ul class="submenu">
                            ...
                            %>
                            <li class="">
                                <a href="views/GC-Business-ReporteMovimientoInventario.jsp">
                                    <i class="menu-icon fa fa-caret-right"></i>
                            ...
                            %>
                            <li class="">
                                <a href="views/GC-Business-ReporteMovimientoInventarioxProducto.jsp">
                                    <i class="menu-icon fa fa-caret-right"></i>
