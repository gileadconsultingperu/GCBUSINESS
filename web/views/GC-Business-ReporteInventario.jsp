<%-- 
    ...
    Sistema             : GC-Business
    Módulo              : Reportes
    Nombre              : GC-Business-ReporteInventario.jsp
    Versión             : 1.0
    Fecha Creación      : 01-11-2018
    Autor Creación      : Pablo Jimenez Aguado
    Uso                 : Exportar Reporte de Inventario por Almacen
--%>
...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>GC BUSINESS - Reporte de Inventario</title>
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Exportar reporte de inventario por familia
                                </small>
                            </h1>
                        </div><!-- /.page-header -->
                        ...
                        <div style="text-align: center;">
                            ...
                            <div>
                                ...
                                <select id="familia" name="familia" tabindex="3" style="width: 140px;">
                                    <option value="0" selected="selected">TODAS</option>
                                    <%
                                        DaoFamiliaProductoImpl daoFamilia = new DaoFamiliaProductoImpl();
                                        List<BeanFamiliaProducto> familia = daoFamilia.accionListar();

                                        for (int i = 0; i < familia.size(); i++) {
                                    %>
                                    <option value="<%=familia.get(i).getIdfamiliaproducto()%>">
                                        <%=familia.get(i).getDescripcion()%> 
                                    </option>
                                    <%
                                        }
                                    %>
