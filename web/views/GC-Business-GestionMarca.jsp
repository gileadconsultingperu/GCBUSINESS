<%-- 
    ...
    Nombre              : GC-Business-GestionMarca.jsp
    Versión             : 1.0
    Fecha Creación      : 21-08-2018
    Autor Creación      : Pablo Jimenez Aguado
    Uso                 : Crear, Modificar, Consultar e Inactivar una marca
--%>
...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>GC BUSINESS - Gestión de Marcas</title>
    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Crear, modificar, eliminar marcaes
                                </small>
                            </h1>
                        </div><!-- /.page-header -->
            ...
            <!-- Modales -->
            <div class="modal" id="modalAgregarMarca" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="blue bigger">Registrar Nueva Marca</h4>
                        </div>
        ...
        <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        $('body').on('shown.bs.modal', '#modalAgregarMarca', function () {
                        ...
                        new $.fn.dataTable.Buttons(tablaMarcas, {
                            buttons: [
                                {
                                    ...
                                    "action": function () {
                                        ...
                                        $('#modalAgregarMarca .blue').text('Registrar Nueva Marca');
                        ...
                        tablaMarcas.buttons().container().appendTo($('.tableTools-container'));
                        ...
                        $('#btnGuardar').click(function (event) {
                            ...
                            $.ajax({
                                method: "POST",
                                url: "../Marca",
                                data: {"opcion": opcion, "idmarca": idmarca, "descripcion": descripcion, "estado": estado}
                            }).done(function (data) {
                        ...
                        $(document).on('click', '.actualizar', function () {
                            ...
                            $.ajax({
                                url: "../Marca",
                                method: "POST",
                                data: {"opcion": "buscar", "idmarca": idmarca},
                                success: function (data) {
                                    var obj = jQuery.parseJSON(data);
                                    $('#opcion').val('actualizar');
                                    $('#idmarca').val(obj.idmarca);
                                    $('#descripcion').val(obj.descripcion);
                                    $('#estado').val(obj.estado);
                                    $('#divestado').hide();
                                    $('#modalAgregarMarca .blue').text('Modificar Marca');
                                    $('#modalAgregarMarca').modal('show');
                                },
                        ...
                        $(document).on('click', '.eliminar', function () {
                            ...
                            $.ajax({
                                url: "../Marca",
                                method: "POST",
                                data: {"opcion": "eliminar", "idmarca": idmarca},
                                success: function (data) {
                                    var obj = jQuery.parseJSON(data);
                                    if (obj.mensaje.indexOf('ERROR') !== -1) {
                                        $('.divError').html(obj.html);
                        ...
                        $(document).on('click', '.activar', function () {
                            ...
                            $.ajax({
                                url: "../Marca",
                                method: "POST",
                                data: {"opcion": "activar", "idmarca": idmarca},
                                success: function (data) {
                                    var obj = jQuery.parseJSON(data);
                                    if (obj.mensaje.indexOf('ERROR') !== -1) {
                                        $('.divError').html(obj.html);
