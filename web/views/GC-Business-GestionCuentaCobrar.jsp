<%-- 
    ...
    Sistema             : GC-Business
    Módulo              : Clientes
    Nombre              : GC-Business-GestionCuentaCobrar.jsp
    Versión             : 1.0
    Fecha Creación      : 28-10-2018
    Autor Creación      : Pablo Jimenez Aguado
    Uso                 : Gestionar Cuentas por Cobrar
--%>
...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>GC BUSINESS - Gestión de Cuentas por Cobrar</title>
                                    ...
                                    <div class="row">                
                                        <div class="col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="cliente" class="control-label" style="width: 60px;">Cliente:</label>
                                                <select class="chosen-select" id="cliente" tabindex="1" style="width: 540px;" data-placeholder="Seleccione cliente...">
                                            ...
                                            <div class="form-group">
                                                <div id="divtablaCuentaCobrar" class="col-md-12">        			
                                                    <div class="table-responsive">
                                                        <table id="tablaCuentaCobrar" class="table table-bordered table-striped table-hover">
                                                            <thead>
                                                                <tr>
                                                                    <th>Fecha Venta</th>
                                                                    <th>Comprobante</th>
                ...
                <div class="modal-dialog" role="document">                                            
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modalPagosLabel">Cobros</h4>
                        </div>
                        <div class="modal-body">
                            <form id="formRegistrarPago" class="form-horizontal" action="" method="POST">  
                                <input type="hidden" id="idcuentaCobrar" name="idcuentaCobrar" value="0">
                                <div class="form-group"> 
                                ...
                                <div class="divPago" style="display: none;">
                                    &nbsp;
                                    <div class="form-group">
                                        <label class="col-sm-3">Realizar Cobro</label><input type="checkbox" id="chkPago" checked value="N">
                                    </div>
                                    <div class="form-group"> 
                                        ...
                                        $(document).ready(function () {
                                            ...
                                            $('#cliente').change(function () {
                                                ...
                                                if (idcliente !== null && idcliente !== "") {
                                                    ...
                                                    cargarCuentasCobrar(idcliente, estadoCC);
                                                }
                                            });
                                            ...
                                            function cargarCuentasCobrar(idcliente, estado) {
                                                var tablaCuentaCobrar = $('#tablaCuentaCobrar').DataTable({
                                                    bAutoWidth: false,
                                                    "processing": true,
                                                    "iDisplayLength": -1,
                                                    "bLengthChange": false,
                                                    ...
                                                    ajax: {
                                                        method: "POST",
                                                        url: "../CuentaCobrar?opcion=listar&idcliente=" + idcliente + "&estado=" + estado,
                                                        dataSrc: "dataCuentaCobrar"
                                                    },
                                                    columns: [
                                                        {"data": "fechaventa"},
                                                        {"data": "comprobante"},
                                                ...
                                                new $.fn.dataTable.Buttons(tablaCuentaCobrar, {
                                                    buttons: [
                                                        {
                                                            "extend": "copy",
                                                ...
                                                tablaCuentaCobrar.buttons().container().appendTo($('.tableTools-container'));
                                            }
                                            ;
                                            ...
                                            function cargarPagos(idCuentaCobrar) {
                                                var dataTable = $('#tablaPagos').DataTable({
                                                    ...
                                                    ajax: {
                                                        method: "POST",
                                                        url: "../CuentaCobrar?opcion=listarmovimientos&idcuentacobrar=" + idCuentaCobrar,
                                                        dataSrc: "dataMovimientosCuentaCobrar"
                                                    },
                                                    columns: [
                                                        {"data": "idMovimientoCC"},
                                                        {"data": "nroPago"},
                                            ...
                                            function habilitarPago() {
                                                $("#montoCobrar").prop('disabled', false);
                                            ...
                                            function deshabilitarPago() {
                                                ...
                                                $("#montoCobrar").prop('disabled', true);
                                            ...
                                            $('#aceptarPago').click(function (event) {
                                                ...
                                                var cant = $('#montoCobrar').val();
                                                if (cant === "" || cant === null) {
                                                    alertify.error("Debe ingresar el monto a cobrar");
                                                    $('#montoCobrar').focus();
                                                    return;
                                                } else {
                                                    ...
                                                    var b = cant - a;
                                                    if (cant === "0" || (a === 0 && b === 0)) {
                                                        alertify.error("Cuidado! El monto a cobrar es CERO");
                                                        $('#montoCobrar').focus();
                                                        return;
                                                    } else {
                                                        if (parseFloat(cant) > parseFloat(saldo)) {
                                                            alertify.error("Cuidado! El monto a cobrar es MAYOR a la deuda");
                                                            $('#montoCobrar').focus();
                                                            return;
                                                        } else {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                if (obj.mensaje.indexOf('ERROR') !== -1) {
                                                                    ...
                                                                    cargarCuentasCobrar($('#idcliente').val(), "P");
                                                                    $(".divPago").each(function () {
                                                                        $(this).prop("style").display = "none";
                                                                    });
                                            ...
                                            $('#btnLimpiar').click(function () {
                                                ...
                                                $('#idcliente').val('0');
                                                $('#estadoCC').val("P");
                                                $('#tablaCuentaCobrar tbody').remove();
                                            });
