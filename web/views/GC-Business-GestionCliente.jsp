...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>GC BUSINESS - Gestión de Clientes</title>
    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Gestión Clientes</li>
                        </ul><!-- /.breadcrumb -->
                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Crear, modificar, eliminar clientes
                                </small>
                            </h1>
                        </div><!-- /.page-header -->
            ...
            <!-- Modales -->
            <div class="modal" id="modalAgregarCliente" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="blue bigger">Registrar Nuevo Cliente</h4>
                        </div>
        ...
        <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        $('body').on('shown.bs.modal', '#modalAgregarCliente', function () {
                        ...
                        $(document).on('click', '.eliminar', function () {
                            ...
                            $.ajax({
                                url: "../Cliente",
                                method: "POST",
                                data: {"opcion": "eliminar", "idcliente": idcliente},
                                success: function (data) {
                                    var obj = jQuery.parseJSON(data);
                                    if (obj.mensaje.indexOf('ERROR') !== -1) {
                                        $('.divError').html(obj.html);
                        ...
                        $(document).on('click', '.activar', function () {
                            ...
                            $.ajax({
                                url: "../Cliente",
                                method: "POST",
                                data: {"opcion": "activar", "idcliente": idcliente},
                                success: function (data) {
                                    var obj = jQuery.parseJSON(data);
                                    if (obj.mensaje.indexOf('ERROR') !== -1) {
                                        $('.divError').html(obj.html);
                        ...
                        $('#buscarWS').click(function (event) {
                            ...
                            $.ajax({
                                ...
                                if (idtipodocumento === '1') {
                                    ...
                                    var codigoubidistrito = obj.ubigeo + "";
                                    var ubidepartamento = codigoubidistrito.substr(0, 2);
                                    $('#departamento').val(ubidepartamento);
                                    $.get('../Ubigeo', {
                                        "codigo_ubidepartamento": ubidepartamento
