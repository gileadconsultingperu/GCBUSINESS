...
public class DTODetalleVenta implements Serializable {
    ...
    public DTODetalleVenta(Integer iddetalleventa, Integer idventa, Integer idproducto, Integer idlote, String codigoproducto, String nombreproducto, String unidadmedida, Double cantidad, String tipoigv, String afectoigv, Double pctoigv, Double valorunitarioventa, Double preciounitarioventa, Double valorventa, Double precioventa, Double montoigv, String tipoisc, Double montoisc, String flagbonificacion, String tipodescuento, Double montodescuento, Double pctodescuento, Double valorunitariodescuento, Double preciounitariodescuento, Double valorventadescuento, Double precioventadescuento, Double montoigvdescuento) {
