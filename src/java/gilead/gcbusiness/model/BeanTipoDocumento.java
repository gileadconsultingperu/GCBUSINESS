/** 
    ...
    Sistema             : GC-Business
    Módulo              : Sistema
    Nombre              : BeanTipoDocumento.java
    Versión             : 1.0
    Fecha Creación      : 22-08-2018
    Autor Creación      : Pablo Jimenez Aguado
    Uso                 : Clase que representa la tabla TipoDocumento de la BD
*/
...
public class BeanTipoDocumento implements Serializable{
    ...
    public BeanTipoDocumento(Integer idtipodocumento, String codigoSunat, String descripcion, String abreviatura, String estado, Timestamp fechaInsercion, String usuarioInsercion, String terminalInsercion, String ipInsercion, Timestamp fechaModificacion, String usuarioModificacion, String terminalModificacion, String ipModificacion) {
