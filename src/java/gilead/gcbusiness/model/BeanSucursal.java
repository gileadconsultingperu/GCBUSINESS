/** 
    ...
    Sistema             : GC-Business
    Módulo              : Seguridad
    Nombre              : BeanSucursal.java
    Versión             : 1.0
    Fecha Creación      : 22-08-2018
    Autor Creación      : Pablo Jimenez Aguado
    Uso                 : Clase que representa la tabla Sucursal de la BD
*/
...
public class BeanSucursal {
    ...
    public BeanSucursal(Integer idsucursal, Integer idempresa, String descripcion, String direccion, String telefono, String estado, Timestamp fechaInsercion, String usuarioInsercion, String terminalInsercion, String ipInsercion, Timestamp fechaModificacion, String usuarioModificacion, String terminalModificacion, String ipModificacion) {
