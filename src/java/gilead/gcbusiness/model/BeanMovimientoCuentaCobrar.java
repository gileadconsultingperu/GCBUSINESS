...
public class BeanMovimientoCuentaCobrar implements Serializable{
    
    private Integer idmovimientocuentacobrar;
    ...
    public BeanMovimientoCuentaCobrar() {
    }

    public BeanMovimientoCuentaCobrar(Integer idmovimientocuentacobrar, Integer idcuentacobrar, Timestamp fecha, Double monto, Double saldoanterior, Double saldoactual, String documentoreferencia, String estado, String motivoanulacion, Timestamp fechaInsercion, String usuarioInsercion, String terminalInsercion, String ipInsercion, Timestamp fechaModificacion, String usuarioModificacion, String terminalModificacion, String ipModificacion) {
        this.idmovimientocuentacobrar = idmovimientocuentacobrar;
    ...
    /**
     * @return the idmovimientocuentacobrar
     */
    public Integer getIdmovimientocuentacobrar() {
        return idmovimientocuentacobrar;
    }

    /**
     * @param idmovimientocuentacobrar the idmovimientocuentacobrar to set
     */
    public void setIdmovimientocuentacobrar(Integer idmovimientocuentacobrar) {
        this.idmovimientocuentacobrar = idmovimientocuentacobrar;
    }
